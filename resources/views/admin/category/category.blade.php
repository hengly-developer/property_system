            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="col-md-12 panel-heading">
                        <h5 class="pull-left">{{ __('lang.category') }}</h5>
                        <h5 class="pull-right">
                            ...
                            <a href="{{ action('Admin\ProductCategory\ProductCategoryController@add') }}" class="btn btn-primary btn-sm">{{ __('lang.add_new') }}</a>
                        </h5>
