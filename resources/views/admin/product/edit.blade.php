        ...
        <div class="col-xs-12">
            <div class="col-xs-12">
                <div class="panel panel-info">
                    ...
                    <form action="{{ action('Admin\Product\ProductController@save') }}" method="POST">
                        ...
                        <div class="panel-footer text-right">
                            <a href="{{ action('Admin\Product\ProductController@index') }}" class="btn btn-sm btn-danger">{{ __('lang.cancel') }}</a>
